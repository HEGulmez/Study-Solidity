...
contract TokenA is IToken {
    ...
    function transfer(address _recipient, uint256 _amount) override external {
    ...
    function transferFrom(address _from, address _to, uint256 _amount) override external {
